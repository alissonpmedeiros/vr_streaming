#How to prevent the violin plots from getting 0 values in the following code?
...
df = pd.read_csv(r'/Users/alisson-cds/Downloads/merged_files2.csv')
...
#plt.savefig("/Users/alisson-cds/Downloads/plots/violin_plot2.pdf", format="pdf", bbox_inches='tight')
plt.show()
