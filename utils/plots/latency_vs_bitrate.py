#The following code generates 4 subplots. For subplot 1 draw a horizontal line at y=1000. For subplot 2 draw a vertical line at x=2000. For subplot 3 draw a vertical line at x=3000. For subplot 4 draw a vertical line at x=4000.

import pandas as pd
import seaborn as sns
import matplotlib.pyplot as plt

def generate_lmplot(x_column_name, y_column_name, x_label_name, ylabel_name, legend_flag, subtitle_flag, xticks_flag):
    ...
    if subtitle_flag:
        ...
        a0.set_title("", fontdict={'size': 10})
        a1.set_title("", fontdict={'size': 10})
        a2.set_title("", fontdict={'size': 10})
        a3.set_title("", fontdict={'size': 10})
    
    if xticks_flag:
        a0.set_xlabel(x_label_name, fontdict={'size': 10})
        a1.set_xlabel(x_label_name, fontdict={'size': 10})
        a2.set_xlabel(x_label_name, fontdict={'size': 10})
        a3.set_xlabel(x_label_name, fontdict={'size': 10})
    else: 
        a0.set_xlabel("", fontdict={'size': 10})
        a1.set_xlabel("", fontdict={'size': 10})
        a2.set_xlabel("", fontdict={'size': 10})
        a3.set_xlabel("", fontdict={'size': 10})
    ...
    if legend_flag:
        plt.legend(loc='lower center', bbox_to_anchor=(-1.11, -0.33), ncol=3)
...
generate_lmplot("e2e_latency", "allocated_bw", 'E2E latency', 'Bitrate', True, True, True)
#generate_lmplot("standard_8k", 'Standard 8K video resolutions', False, True, False)
#generate_lmplot("high_8k", 'High 8K video resolutions', False, False, False)
#generate_lmplot("full_8k", '8K video resolutions running at 60 FPS', True, False, True)
